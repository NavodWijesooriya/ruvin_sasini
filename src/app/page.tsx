    ...
    <main className="min-h-screen">
      ...
      <footer className="py-12 bg-primary text-primary-foreground text-center">
        <div className="max-w-4xl mx-auto px-6 space-y-4">
          ...
          <p className="text-sm md:text-base font-medium tracking-wide opacity-90">Sasini - 075 3396 452</p>
          <p className="text-sm md:text-base font-medium tracking-wide opacity-90">Mino - 077 8776 808</p>
